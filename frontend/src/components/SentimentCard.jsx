...
const SentimentCard = ({ title, score, delta, icon: Icon, data = [] }) => {
    ...
    return (
        <motion.div
            ...
            className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 p-5 rounded-xl hover:shadow-md transition-all hover:border-brand-200 dark:hover:border-zinc-700 relative overflow-hidden group"
        >
