...
def _seed_records() -> List[Dict[str, Any]]:
    ...
    source_mix = {
        "neutrogena": [("reddit", 38), ("youtube", 22), ("reviews", 25), ("news", 15)],
        "la_roche_posay": [("reviews", 40), ("news", 22), ("reddit", 20), ("youtube", 18)],
        "cerave": [("reviews", 45), ("reddit", 25), ("youtube", 15), ("news", 15)],
        "supergoop": [("youtube", 32), ("reddit", 28), ("reviews", 25), ("news", 15)],
    }
    volume_base = {
        "sunscreen": 4,
        "moisturizer": 3,
    ...
    for day_offset in range(0, 60):
        ...
        for product_index, (product_id, _) in enumerate(SEED_PRODUCTS):
            ...
            mix = source_mix.get(product_id) or [("reviews", 40), ("reddit", 25), ("youtube", 20), ("news", 15)]
